...
export default function ContactsPage() {
  ...
  async function handleBulkDelete() {
    ...
    if (error) {
      toast.error('No se pudieron borrar los contactos');
    } else {
      toast.success(`${ids.length} contacto${ids.length === 1 ? '' : 's'} borrado${ids.length === 1 ? '' : 's'}`);
      setSelected(new Set());
      fetchContacts();
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Gestioná tu lista de contactos. {totalCount > 0 && `${totalCount} en total.`}
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    aria-label={`Quitar el filtro ${tag.name}`}
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-popover-foreground">Borrar contacto</DialogTitle>
        ...
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-popover-foreground">
              Borrar {selected.size} {selected.size === 1 ? 'contacto' : 'contactos'}
            </DialogTitle>
            <DialogDescription className="text-muted-foreground">
