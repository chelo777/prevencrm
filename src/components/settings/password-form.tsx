...
export function PasswordForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!profile?.email) {
      toast.error('No se puede cambiar la contraseña sin un email actual');
      return;
    }
    ...
    if (next !== confirm) {
      setConfirmError('La contraseña nueva y la confirmación no coinciden');
      return;
    }
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-muted-foreground">
          Usá al menos {MIN_PASSWORD} caracteres. Vas a seguir con la sesión
          iniciada en este dispositivo después de cambiarla.
        </CardDescription>
      </CardHeader>
