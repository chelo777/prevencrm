...
export function TagManager() {
  ...
  async function handleDelete() {
    ...
    try {
      ...
      toast.error('No se pudo borrar la etiqueta');
    } finally {
      setDeleting(false);
    }
  }
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-muted-foreground">
          Etiquetas de colores para agrupar y filtrar contactos.
        </CardDescription>
      </CardHeader>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              ¿Borrar la etiqueta &quot;{tagToDelete?.name}&quot;? Se quita de
              todos los contactos y no se puede deshacer.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
