...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: "violet",
    name: "Violeta",
    tagline: "El predeterminado — seguro, con un toque distendido.",
    swatch: "oklch(0.526 0.247 293)",
  },
  {
    id: "emerald",
    name: "Esmeralda",
    tagline: "Evoca crecimiento y mensajería, sin copiar el verde de WhatsApp.",
    swatch: "oklch(0.62 0.16 162)",
  },
  {
    id: "cobalt",
    name: "Cobalto",
    tagline: "Azul B2B-SaaS prolijo — calmo y con onda a producto.",
    swatch: "oklch(0.585 0.2 254)",
  },
  {
    id: "amber",
    name: "Ámbar",
    tagline: "Cálido y cercano — se siente bien para equipos de pyme.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosa",
    tagline: "Audaz y moderno — D2C, creadores, estilo de vida.",
