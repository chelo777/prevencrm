-- ============================================================
-- 036_notifications_es.sql — notificaciones de asignación en español
--
-- Migración 027 dejó el título/cuerpo de la notificación en inglés
-- ("New conversation assigned", "X assigned you a conversation with
-- Y"). Reemplaza SOLO el cuerpo de la función — mismo trigger, misma
-- tabla, mismo tipo — para que el mensaje que ve el agente en /notifications
-- salga en español.
--
